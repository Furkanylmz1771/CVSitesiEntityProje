...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <img src="web/images/FYPP.jpg"  width="150px" alt="news image" class="img-fluid navimg">
            
        


            <h1 class="top_hd mt-2"><a href="index.html">Furkan Yılmaz</a></h1>
    ...
    <div class="main">
        <div class="banner-text-w3ls" id="home">
         ...
         <section class="slide-wrapper" id="about">
           ...
           <p>Benim adım Furkan 23 yaşındayım. Üniversitede Uçak Teknolojisi
                bölümünden mezun olduktan sonra belirli sebeplerden dolayı o işte
                devam etmeme kararı aldım ve daha sonra yazılım ile ilgilenmeye
                başladım. Bu işte ilerlemeye karar verdikten hemen sona Bilge Adam
                akademiye katıldım ve .Net eğitimi aldım. Yakın zamanda eğitimi
                tamamladım ve bu alanda işe girme arayışındayım </p> 
